  ...
  return (
    <div style={{ padding: "2rem" }}>
      <div style={{ marginBottom: "2rem" }}>
        <h1 style={{ fontSize: "2rem", fontWeight: "bold" }}>Admin Dashboard (Server Component)</h1>
        <p style={{ marginTop: "0.5rem" }}>This is a server-rendered page with no client-side dependencies</p>
      </div>
